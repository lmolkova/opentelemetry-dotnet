...
namespace OpenTelemetry.Trace
{
    ...
    public sealed class TracerFactorySdk : TracerFactory
    {
        ...
        {
            this.spanProcessor = spanProcessor ?? new BatchingSpanProcessor(new NoopSpanExporter());
            this.tracerConfigurationOptions = tracerConfigurationOptions ?? new TracerConfigurationOptions();
